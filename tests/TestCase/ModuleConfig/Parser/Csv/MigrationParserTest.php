...
class MigrationParserTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $file = dirname(dirname(dirname(dirname(__DIR__)))) . DS . 'data' . DS . 'Modules' . DS . 'Foo' . DS . 'db' . DS . 'migration.csv';
    ...
    {
        $file = dirname(dirname(dirname(dirname(__DIR__)))) . DS . 'data' . DS . 'CsvMigrations' . DS . 'migrations' . DS . 'Foo' . DS . 'migration.csv';
        $parser = new MigrationParser();
